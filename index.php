...
<html>
 ...
 <body>
  <br /><br />
  <div class="container">
   <h2 align="center">Criar Pastas & Anexar Arquivo</a></h2>
   <br />
   <div align="right">
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    ...
    <h4 class="modal-title"><span id="change_title">Criar Pasta</span></h4>
   </div>
   <div class="modal-body">
    <p>Digite o Nome da pasta
...
$(document).ready(function(){
 ...
 $(document).on("click", ".delete", function(){
  var folder_name = $(this).data("name");
  var action = "delete";
  if(confirm("Tem certeza que quer apagar isso?"))
  {
   $.ajax({
    url:"action.php",
    method:"POST",
 ...
 $(document).on('click', '.remove_file', function(){
  ...
  if(confirm("Tem certeza que quer baixar esse arquivo?"))
  {
   $.ajax({
    url:"action.php",
    method:"POST",
